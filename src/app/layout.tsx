...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/assets/logo/ac_doctor.png",
    shortcut: "/assets/logo/ac_doctor.png",
    apple: "/assets/logo/ac_doctor.png",
  },
  ...
  openGraph: {
    ...
    description:
      "Professional AC services at your doorstep. Book repair, installation & more.",
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="bg-brand-white text-[#222]">
