...
export function Footer() {
 ...
 href="#"
 aria-label={label}
 className="text-[#888] hover:text-[#e31e25] "
 >
 <Icon />
 </Link>
 ))}
 ...
 <Link
 href={href}
 className="font-['Poppins',sans-serif] font-normal text-[18px] text-[#d9d9d9] hover:text-[#e31e25] leading-normal"
 >
 {label}
 </Link>
 </li>
 ...
 className="font-['Montserrat',sans-serif] font-medium text-[16px] text-[#d9d9d9] underline decoration-solid hover:text-[#e31e25] leading-normal"
 >
 info@acdoctor.in
 </a>
 </div>
 ...
 className="font-['Poppins',sans-serif] font-normal text-[16px] text-[#d9d9d9] hover:text-[#e31e25] leading-normal"
 >
 +91 89598 98989
 </a>
 </div>
 ...
 <Link
 href={href}
 className="font-['Poppins',sans-serif] font-normal text-[16px] sm:text-[18px] text-[#d9d9d9] hover:text-[#e31e25] leading-normal"
 >
 {label}
 </Link>
 </li>
 ...
 <Link href="#" className="hover:text-[#e31e25] ">
 Privacy Policy
 </Link>
