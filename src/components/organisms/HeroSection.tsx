 ...
 */}
 ...
 >
 <span className="w-2 h-2 rounded-full bg-[#e31e25] shrink-0" />
 ...
 className="font-['Montserrat',sans-serif] font-semibold text-[15px] text-white bg-[#e31e25] hover:bg-[#c8181e] active:bg-[#b5161c] px-8 py-[14px] rounded-full shadow-[0_4px_20px_rgba(227,30,37,0.45)] hover:shadow-[0_6px_28px_rgba(227,30,37,0.6)]"
 >
 Shop Now
 </button>
 <button
 ...
 className="font-['Montserrat',sans-serif] font-semibold text-[15px] text-white bg-transparent hover:bg-white/10 border-2 border-white/70 hover:border-white px-8 py-[14px] rounded-full "
 >
 Book Service
 </button>
 </div>
 ...
 onClick={() => scrollTo("products")}
 aria-label="Shop AC products"
 className="font-['Montserrat',sans-serif] rounded-full bg-[#cf1e2a] px-[25px] py-[14px] text-[14px] font-semibold text-white shadow-[0_4px_20px_rgba(227,30,37,0.45)] hover:bg-[#c8181e] active:bg-[#b5161c] sm:px-8 sm:text-[15px]"
 >
 Shop Now
 </button>
 <button
 onClick={() => scrollTo("services")}
 aria-label="Book an AC service"
 className="font-['Montserrat',sans-serif] rounded-full border border-white bg-white/10 px-[22px] py-[14px] text-[14px] font-semibold text-white hover:border-white hover:bg-white/15 sm:px-8 sm:text-[15px]"
 >
 Book Service
 </button>
 </div>
